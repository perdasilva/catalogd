...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResolvedWebSource) DeepCopyInto(out *ResolvedWebSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResolvedWebSource.
func (in *ResolvedWebSource) DeepCopy() *ResolvedWebSource {
	if in == nil {
		return nil
	}
	out := new(ResolvedWebSource)
